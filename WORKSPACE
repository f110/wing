...
http_archive(
    ...
    sha256 = "4e7f899c36973540943746a5ca754b38ac079a19205d6abfc65397da2ed502d6",
    strip_prefix = "rules_k8s_controller-0.9.0",
    urls = [
        "https://github.com/f110/rules_k8s_controller/archive/v0.9.0.tar.gz",
    ],
)
